...
export function useMarketsQuery({ category = "All", q = "", sort = "volume", pageSize = 15 }: MarketsQueryArgs) {
	return useInfiniteQuery<
	MarketsPage,
	Error,
	InfiniteData<MarketsPage, string | null>,
	QueryKey,
	string | null
	>({
	queryKey: ["markets", { category, q, sort, pageSize }],
