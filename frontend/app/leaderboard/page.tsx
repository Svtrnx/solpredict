...
import { LeaderboardPeriod, LeaderboardItem } from "@/lib/types"
          ...
          <CardContent className="pt-8 pb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 px-4">
              ...
              <Link href="/dashboard" className="w-full sm:w-auto">
                <Button variant="outline" size="lg" className="w-full cursor-pointer sm:w-auto glass hover:glow bg-transparent">
